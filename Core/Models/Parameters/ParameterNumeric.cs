...
namespace Core
{
    public class ParameterNumeric : SettingNumericItemBase, IParameter
    {
        #region Fields
        ...
        public ParameterNumeric(string label, double value, bool isRejectFound, bool isUsed, bool isEnabled, string subtitle, 
            ISettingItemOption settingItemOption)
            : base(label, value, settingItemOption)
        {
            _IsRejectFound = isRejectFound;
            _IsUsed = isUsed;
            _IsEnabled = isEnabled;
            _Subtitle = subtitle;
        }
        public ParameterNumeric(string label, double value, bool isRejectFound, bool isUsed, bool isEnabled, string subtitle, int view, int category,
            ISettingItemOption settingItemOption)
            : base(label, value, settingItemOption)
        {
            _IsRejectFound = isRejectFound;

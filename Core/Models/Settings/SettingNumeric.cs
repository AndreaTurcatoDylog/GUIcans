...
namespace Core
{
    public class SettingNumeric : SettingNumericItemBase, ISettingItem
    {

        #region Constructor

        public SettingNumeric(string label, double value, ISettingItemOption settingItemOption)
    ...
    //public class SettingNumeric : SettingItemBase, ISettingWithValue
    //{
    //    #region Fields
